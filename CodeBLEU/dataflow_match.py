...
def calc_dataflow_match(references, candidate, lang, path):
    return corpus_dataflow_match([references], [candidate], lang, path)


def corpus_dataflow_match(references, candidates, lang, path):
