...
if __name__ == '__main__':
    ...
    # ref_path is the absolute path to the tokenized cpp references i.e ground truths (also called gold functions), one function per line.
    # hyp_paths is the list of paths of the generated functions. len(hyp_paths) = beam size. If you generate only one hypothesis per function, len(hyp_paths) = 1. You have one function per line.
